...
3.  At the end of the **CreateBlob** method and before the closing curly brackets, create a new **CloudBlobContainer** for the **signin** container.
...
5.  At the end of the **CreateBlob** method and before the closing curly brackets, create a new variable named *blobName*:
...
7.  At the end of the **CreateBlob** method and before the closing curly brackets, create a block blob reference by using the **GetBlockBlobReference** method and the *blobName* variable as the parameter:
...
10. At the end of the **CreateBlob** method and before the closing curly brackets, add the following statement:
...
6.  At the end of the **GetStream** method and before the closing curly brackets, create a new **CloudBlobClient** variable for the *\_storageAccount* variable:
...
9.  At the end of the **GetStream** method and before the closing curly brackets, create a block blob reference by using the **GetBlockBlobReference** method and the *\_blobId* variable as the parameter:
...
11. At the end of the **GetStream** method and before the closing curly brackets, create a new instance of the **DownloadPayload** class:
...
6.  At the end of the **GetSecureUrl** method and before the closing curly brackets, create a new **CloudBlobClient** for the *\_storageAccount* variable.
...
9.  At the end of the **GetSecureUrl** method and before the closing curly brackets, create a new instance of the **SharedAccessBlobPolicy** class:
...
12. At the end of the **GetSecureUrl** method and before the closing curly brackets, create a new instance of the **BlobContainerPermissions** class:
...
15. At the end of the **GetSecureUrl** method and before the closing curly brackets, call the asynchronous **SetPermissionsAsync** method of the *CloudBlobContainer* variable by using the *BlobContainerPermissions* variable as the parameter:
...
17. At the end of the **GetSecureUrl** method and before the closing curly brackets, create a block blob reference by using the **GetBlockBlobReference** method and the *\_blobId* variable as the parameter:
...
19. At the end of the **GetSecureUrl** method and before the closing curly brackets, concatenate the **AbsoluteUri** of the *Uri* variable and the *sasToken* variable:
